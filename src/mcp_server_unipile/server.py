...
class _LazyClient:
    """Delays UnipileClient initialization until first attribute access."""
    _instance: Optional[UnipileClient] = None

    def __getattr__(self, name):
        if _LazyClient._instance is None:
            _LazyClient._instance = UnipileClient()
        return getattr(_LazyClient._instance, name)
